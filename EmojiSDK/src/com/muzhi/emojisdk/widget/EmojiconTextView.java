...
public class EmojiconTextView extends TextView {
    ...
    private void init(AttributeSet attrs) {
        if (attrs == null) {
            ...
            TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.EmojiInfo);
            mEmojiconSize = (int) a.getDimension(R.styleable.EmojiInfo_emojiconSize, getTextSize());
            a.recycle();
        }
        setText(getText());
    }
